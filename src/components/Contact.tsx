...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (contactMethod === 'phone') {
      ...
      const messageBody = `
New Contact from GodFather Renovations Website
-----------------------
Name: ${formData.name}
Message: ${formData.message}
      ...
      const phoneNumber = '6047205687'; // Your phone number
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
                ...
                <div className="space-y-4 flex-shrink-0">
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="tel:+16047205687" className="text-gray-600 hover:text-primary transition-colors">
                          +1 (604) 720-5687
                        </a>
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText('+1 (604) 720-5687');
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center gap-2">
                        <a
                          href="mailto:god.father.renovation@gmail.com"
                          className="text-gray-600 hover:text-primary transition-colors break-all"
                        >
                          god.father.renovation@gmail.com
                        </a>
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText('god.father.renovation@gmail.com');
                            // You could add a toast notification here
                          }}
                          className="text-gray-400 hover:text-primary transition-colors p-1 rounded-full hover:bg-gray-200"
                        >
        ...
        >
          <div className="w-full mt-4">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2610.788714396032!2d-122.71054242351997!3d49.12864777137007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e960b640bd79265%3A0xa5fc3774081dad2e!2sInfinite%20Shine%20Exotics%20Car%20Detailing!5e0!3m2!1sen!2sca!4v1738642932105!5m2!1sen!2sca"
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowFullScreen
