        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8">
              From concept to completion, GodFather Renovations brings your vision to life with quality craftsmanship and attention to detail.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Create your dream kitchen and bathroom with modern designs and premium materials.',
              },
              {
                title: 'Custom Renovations',
                image:
                  'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80',
                description: 'Personalized renovation solutions tailored to your unique style and needs.',
              },
            ].map((service, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-secondary mb-4">Why Choose GodFather Renovations</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
